...
\item But later on when I have time, I will come back for more 2D/3D graphics drawing here.
\end{itemize}
\subsubsection{Snapshot}
\label{sec-3-2-2}
...
\subsection{Issue:}
\label{sec-3-3}
\subsubsection{ViewRootImpl(31835): sendUserActionEvent() mView == null}
\label{sec-3-3-1}
\begin{itemize}
\item \url{http://stackoverflow.com/questions/18028666/senduseractionevent-is-null}
\item It said to be specific device's problem. And I didn't have enough time and internet to go any further from there.
\end{itemize}
\subsection{Todo}
\label{sec-3-4}
