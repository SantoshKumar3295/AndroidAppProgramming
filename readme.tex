...
\end{itemize}
\subsection{updated 12/19/2014, Friday}
\label{sec-9-3}
\begin{itemize}
\item The final report was in \textbf{report.pdf}. Both the hard copy and electronic copy was turned in yesterday (12/18/2014) to the course instructor; I regenerated the .tex and .pdf files today for Github updates because I miss-deleted them today;
\item I didn't want to include in the \textbf{Personal Conclusion} section in my report, but when I got feedback from course instructor on 12/12/2014 and when he used the word "deserve", I felt the instructor was slightly picky on me compared with the other classmate even when I performed better than the other. I felt pushed to include that part in, same happened to later section of \textbf{practise vs practice}. I just expected that education helps build our confidence as students rather than the hardly built confidence got destroyed by any reason.
\item The town is conservative, yet is highly influenced by in-town university; A 19 years old undergraduate girl was gunshot by one university professor who suicide afterwards in summer 2011;
\item My life were almost contaminated by some professor in university but I prevented it from happening from my side because I have one already the fall semester about one year ago;
\item The special person is 13 years elder than me, and we are four-generation far relatives. His grandpa from my uncle's (his dad's) side and my grandpa from my mom's side were siblings sharing same parent. He looks very young though. I would love to get married when environment gets ready.
\item I like my Computer Science major the most. I prefer San Francisco Bay Area job opportunities but I am willing to relocate anywhere in US as far as the company will sponsor \textbf{H1B} work visa for me \textbf{before 4/1/2015} because I won't have any OPT.
\item With semester ended today 5:00pm, finally I am entering into self-learning mode this evening.
\end{itemize}
