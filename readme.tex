...
\subsection{Snapshot}
\label{sec-3-3}
\includegraphics[width=.6\linewidth]{./20141110-14-27-05.png}
...
\item \textbf{Question}: Right now, my image is an ImageView in my layout, what ideas that I could use to set/change/transfer my ImageView to be my draw view background? use Bitmap
\item References:
...
\textbf{Answered}: drawPath.reset() produced all the trouble. Later on, I need to think in a debuggin way/manner.
...
\subsection{Snapshot}
\label{sec-4-3}
\includegraphics[width=.6\linewidth]{./Screenshot_2014-11-17-15-11-20.png}
\subsection{Todo}
\label{sec-4-4}
