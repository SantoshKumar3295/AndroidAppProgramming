...
public class mySqar implements DrawElement {
    ...
    public mySqar mySqarWrap(float startx, float starty, float endx, float endy, Paint myPaint, int color, float size) {
        mySqar result = new mySqar();
